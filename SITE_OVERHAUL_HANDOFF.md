...
Next up: PR 5, the full alphabet crib blanket (knit body, picot edge, the
fixed grid, six body colours) and the placeholder rigs. Phase 1 is then
done and Phase 2 — the storyboarded home, shop and product pages — begins.
