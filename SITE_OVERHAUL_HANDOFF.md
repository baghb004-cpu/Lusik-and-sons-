...
**PR 7 is done.** Next up in Phase 2 is PR 8 (the product page): the
fitting room — pose chips, the compare slider, the "About colors" block
moved under the stage — cart thumbnails of the configured design,
`/welcome` for the brochure QR, and a stitched 404.
