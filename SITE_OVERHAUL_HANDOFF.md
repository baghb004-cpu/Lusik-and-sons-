...
Next up: PR 4 adds the set rigs (Days of the Week, the Anushig pair, the Bari
Akhorzhak set with its cap and colourways) and PR 5 the full alphabet crib
blanket and the placeholders. Both reuse the bib body and the lowercase charts
this PR added, so they are rigs plus posters rather than new architecture.
