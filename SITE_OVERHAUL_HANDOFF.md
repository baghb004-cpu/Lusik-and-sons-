...
**PR 7 and PR 8 are done bar one piece**: cart thumbnails of the
configured design, where the stage exports a small WebP at add-to-cart
time and the bag rows show it.
