...
Next up: PRs 3 to 5 add rigs for the bibs, the sets and the full alphabet
crib blanket. They reuse the engine wholesale — each is a rig plus a poster,
not new architecture — so they should go much faster than PR 2 did.
