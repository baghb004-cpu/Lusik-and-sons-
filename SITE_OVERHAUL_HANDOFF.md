...
**PR 7 is done, and PR 8's two standalone pages with it.** What is left
of PR 8 is the product page itself: the fitting room — pose chips, the
compare slider, the "About colors" block moved under the stage — and
cart thumbnails of the configured design.
