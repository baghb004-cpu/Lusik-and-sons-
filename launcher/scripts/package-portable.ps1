...
New-Item -ItemType Directory -Force -Path dist-portable\projects,dist-portable\app-data,dist-portable\resources,dist-portable\logs,dist-portable\exports,dist-portable\apps | Out-Null
