...
export const JOURNAL_POSTS = [
  ...
  },
  {
    ...
    "content": [
      {
        "type": "p",
        "text": "The blanket and the everyday name bib are different products made by different methods, and that's deliberate. People sometimes ask why the everyday bib isn't hand-stitched too. The honest answer is: a bib that goes through the wash three times a week is a thing that gets ruined."
      },
      {
        "type": "p",
  ...
  },
  {
    ...
    "content": [
      {
        "type": "p",
        "text": "The Armenian alphabet was created in 405 AD by a monk named Mesrop Mashtots, commissioned by King Vramshapuh and the Catholicos Sahak Parthev. Before that, Armenian was written in Greek, Syriac, or Persian script — but none of those captured the actual sounds of the spoken language. Mashtots designed a 36-letter alphabet that matched every Armenian sound, and that core has survived nearly intact for sixteen centuries."
      },
      {
        "type": "p",
        "text": "The first three letters — Ա (Ayb), Բ (Ben), Գ (Gim) — are the alphabet's opening. They're the letters Armenian children learn first. The Armenian word for \"alphabet\" itself, Այբուբեն (Aybuben), is built from the names of the first two letters, the way \"alpha-beta\" became \"alphabet\" in Greek."
      },
      {
        "type": "h2",
        "text": "Why the first three letters matter"
      },
      {
        "type": "p",
        "text": "To stitch Ա Բ Գ onto a blanket is to give a child the beginning of their language — literally the first three steps into reading it. It's a quiet kind of inheritance: nobody's reading the blanket to the baby yet, but the letters are there, and one day the same child who slept under them will recognize them on a page."
      },
      {
        "type": "p",
        "text": "Two more letters were added during the Middle Ages: Օ (Oh) and Ֆ (Feh), bringing the total to 38. The original 36 are still what most Armenian primers teach as \"the alphabet,\" and you'll still see the Mashtots-era letters in old monastery inscriptions if you ever travel to Echmiadzin or Geghard."
      },
      {
        "type": "h2",
        "text": "Or English, if that's the right gift"
      },
      {
        "type": "p",
        "text": "The English ABC follows the same logic. Some families want their child's first letters in Armenian; others want English; many want both. Lusik stitches whichever the parent picks — she doesn't push one over the other. The blanket should be the language the family speaks at home."
      },
      {
        "type": "p",
        "text": "For other letters or special requests — a child's specific initial, an unusual combination, or a custom blanket for a name you'd like spelled out — write Lusik at hello@lusikandsons.com."
      }
    ]
  },
  {
    ...
    "content": [
      {
        "type": "p",
        "text": "Cross-stitch and embroidery aren't the same thing, even though most people use the words interchangeably."
      },
      {
        "type": "p",
        "text": "Embroidery is a broad family of techniques — satin stitch, French knots, chain stitch, machine embroidery — basically any way of decorating fabric with thread. Cross-stitch is one specific technique within that family, but it's old enough and exacting enough to deserve its own name."
      },
      {
        "type": "h2",
        "text": "What makes a stitch a cross-stitch"
      },
      {
        "type": "p",
        "text": "Every mark on the fabric is a small X — two diagonal threads crossing at a single point. The whole picture is built out of those Xs, counted one at a time onto a fabric with an even, gridded weave. There's no improvisation in the stitches themselves; the variation comes entirely from which Xs you place and what color thread you use."
      },
      {
        "type": "p",
        "text": "This is why cross-stitch is sometimes called \"counted embroidery\": you literally count squares of fabric to know where each X goes. The waffle-weave blankets Lusik uses have the count built into the cloth itself — every little square is one stitch."
      },
      {
        "type": "h2",
        "text": "Why a machine can't really do it"
      },
      {
        "type": "p",
        "text": "Machine embroidery uses different stitches — satin and fill — optimized for speed and density. The result is closer to a painted-on image: smooth, regular, opaque. Hand cross-stitch produces something different. You can see the individual stitches, you can feel the texture, and (on the back) you can see the path the stitcher took through the cloth."
      },
      {
        "type": "p",
        "text": "That visibility is part of why cross-stitched gifts get kept. The work is in the work. A grandmother who learned cross-stitch from her grandmother, who learned it from hers, makes something a machine can't approximate at any price."
      },
      {
        "type": "h2",
        "text": "Why the bib is different"
      },
      {
        "type": "p",
        "text": "Lusik does the blanket by hand because the blanket is where the count and texture matter. The bib is machine-embroidered because its surface is too small for hand cross-stitch — a name in cross-stitch on a bib would be unreadable. Each piece gets the technique that suits its size."
      }
    ]
  },
  {
    ...
    "content": [
      {
        "type": "p",
        "text": "If you've ever been in an Armenian home, you've probably seen a pomegranate somewhere. On a tablecloth, woven into a rug, painted on a plate, illuminated in an old manuscript. The pomegranate is, more than any other symbol, the visual shorthand for Armenia."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Lusik chose her blankets specifically for their pomegranate-pattern waffle weave. The pattern is woven into the fabric itself, not stitched on top — small, repeating, embossed across the entire surface. When she cross-stitches the alphabet over it, the pomegranates stay visible underneath, framing each letter the way they'd frame a child's name on an Armenian heirloom from a century ago."
      },
      {
        "type": "p",
        "text": "The blanket carries the symbol whether you notice it or not. A child can grow up underneath pomegranates without ever knowing why, and still inherit something Armenian."
      }
    ]
  }
];
