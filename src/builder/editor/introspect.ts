...
export const FIELD_HELP: Record<string, string> = {
  ...
  "contactButtons.phone": "The number the Call button dials. On a phone, tapping it opens the dialer ready to call you.",
  "contactButtons.sms": "The number the Text button messages. Tapping it opens the visitor's Messages app with a new text to you.",
  "contactButtons.email": "The address the Email button writes to. Tapping it opens the visitor's mail app with a new message to you.",
  "contactButtons.style": "Buttons = labeled pills (Call us / Text us / Email us). Icons = compact icon-only buttons.",
