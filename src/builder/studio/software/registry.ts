...
export const PRESETS: Preset[] = [
  ...
  // 6) Export --------------------------------------------------------------
  p({ id: "export-thumb-drive", name: "Export: Thumb-Drive Runnable", icon: "💾", blurb: "Package the project so it runs straight from a USB drive, offline.", categoryId: "export", subcategoryId: "run", status: "ready", exports: ["thumb-drive"], creates: ["A launcher index.html", "A START-HERE file", "Runs offline from USB"] }),
  p({ id: "export-static-site", name: "Export: Static Website", icon: "🌐", blurb: "A plain website you can host anywhere or open from a file.", categoryId: "export", subcategoryId: "run", status: "ready", exports: ["static-site"], creates: ["A launcher index.html linking every tool", "Plain HTML/CSS/JS"] }),
  p({ id: "export-web-app", name: "Export: Web App", icon: "🕸️", blurb: "An offline-capable web app version of the project.", categoryId: "export", subcategoryId: "run", status: "ready", exports: ["web-app"], creates: ["A web app manifest", "An installable offline app shell"] }),
  p({ id: "export-desktop", name: "Export: Desktop App", icon: "🖥️", blurb: "A desktop app (Electron wrapper) — build the installer with your own Node.", categoryId: "export", subcategoryId: "run", status: "ready", pi: false, exports: ["desktop"], creates: ["An Electron main + package.json", "Build steps for a desktop installer"] }),
  p({ id: "export-mobile", name: "Export: Mobile App", icon: "📱", blurb: "A mobile app (Capacitor wrapper) — build with Android Studio / Xcode.", categoryId: "export", subcategoryId: "run", status: "ready", exports: ["mobile"], creates: ["A Capacitor config", "Build steps for Android / iOS"] }),
  p({ id: "export-raspberry-pi", name: "Make a Raspberry Pi 5 Package", icon: "🍓", blurb: "Lightweight, touchscreen, kiosk-ready build for a Raspberry Pi 5.", categoryId: "export", subcategoryId: "run", status: "ready", exports: ["raspberry-pi"], creates: ["A kiosk start.sh script", "A Pi README with limits", "Touchscreen-ready offline build"] }),
