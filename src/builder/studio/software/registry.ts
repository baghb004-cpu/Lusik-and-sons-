...
export const PRESETS: Preset[] = [
  ...
  p({ id: "export-desktop", name: "Export: Desktop App", icon: "🖥️", blurb: "A desktop app where the platform allows it.", categoryId: "export", subcategoryId: "run", status: "preview", pi: false, exports: ["desktop"], creates: ["Build instructions (needs desktop tooling)"] }),
  p({ id: "export-mobile", name: "Export: Mobile App", icon: "📱", blurb: "A mobile app version where the platform allows it.", categoryId: "export", subcategoryId: "run", status: "preview", exports: ["mobile"], creates: ["Build instructions (needs mobile tooling)"] }),
