  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Mail size={20} strokeWidth={1.5} style={{ color: "var(--accent-text)", marginTop: "2px", flexShrink: 0 }} />
        ...
        >
          <Phone size={20} strokeWidth={1.5} style={{ color: "var(--accent-text)", marginTop: "2px", flexShrink: 0 }} />
          <div className="flex-1 min-w-0">
