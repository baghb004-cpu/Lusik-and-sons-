...
export const PRODUCT = {
  ...
  description: "A soft acrylic crib blanket, woven through with a small pomegranate pattern — the symbol Armenian textiles have carried for a thousand years, embossed quietly into the cloth itself. Onto that cloth, by hand, Lusik cross-stitches the first three letters of the alphabet: Ա Բ Գ in Armenian, or A B C in English. She stitches them twice, in two parallel diagonals that cross the blanket corner to corner, so six letter-squares run across the surface — three letters in one diagonal, the same three again in the other. Made to order, one at a time, in Lusik's home in Southern California. She picks the thread from whatever spools she has on hand the week she makes yours, so no two blankets are exactly alike — the small variations are how you know one woman made it. For other letters or a name you'd like spelled out, write Lusik at hello@lusikandsons.com.",
  specs: [
    'Size: 52" × 52"',
