...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    help: {
      ...
      faq: [
        ...
        { q: "Do you offer local pickup?", a: "Yes — if you're in the Orange County or Los Angeles area, you can pick up your order in person and skip shipping. Just message Lusik (Text us or Email us) after you order and we'll arrange a time and place. Everywhere else in the U.S., shipping is priced by distance from Cypress, CA — $9.99 to $15.49 in the lower 48 — and orders over $150 ship free." },
    ...
    shop: {
      ...
      from: "From ${price}",
      stepIn: "Step in",
      cardPhotoSoon: "Photographs coming soon",
  ...
  hy: {
    ...
    custom: {
      ...
      subtitle: "Թքակալներ և սրբիչներ՝ ձեր երեխայի տառով կամ նկարով։",
      bibTitle: "Մանկական թքակալ",
    ...
    disclaimer: {
      ...
      bibClosure: "Ընթացիկ թքակալները կարող են ունենալ վզի ամրակման այլ համակարգ՝ քան ցուցադրված օրինակները։",
    },
    ...
    // ⚠️ TODO_LUSIK_REVIEW — auto-translated, please refine.
    explore: {
      shop: { title: "Խանութ", blurb: "Ծածկոցներ, թքակալներ և սրբիչներ" },
    ...
    shop: {
      ...
      from: "{price}$-ից",
      stepIn: "Մտնել ներս",
      cardPhotoSoon: "Լուսանկարները շուտով",
      ...
      intro: "Խաչաձև կարկատված ծածկոցներ՝ օրորոցի համար։ Ասեղնագործ թքակալներ՝ խոհանոցի սեղանի համար։ Ծիսական սրբիչներ՝ կարևոր օրերի համար։ Մանր գործվածքե իրեր՝ առաջին շաբաթների համար։ Յուրաքանչյուր կտոր՝ Լուսիկի ձեռքով, իր տնից Հարավային Կալիֆորնիայում՝ պատվերով, տևելու համար։ Ընտրեք կատեգորիա՝ ներս մտնելու համար։",
      ...
      // ⚠️ TODO_LUSIK_REVIEW: «կրծկալ» → «թքակալ» site-wide (the former reads
      // as "bra" in modern usage); burp cloth here is «ուսի սրբիչ».
      newestName: "«Բարի ախորժակ» թքակալի և ուսի սրբիչի հավաքածու",
      ...
      featured: [
        ...
        { eyebrow: "Ամեն օրվա համար", name: "Անհատական անունով թքակալ", tagline: "Ձեր երեխայի անունը՝ հայերեն կամ անգլերեն։", price: "22$-ից" },
      ],
      difference: [
    ...
    bib: {
      ...
      othersTitlePre: "Իրական թքակալներ, որ Լուսիկը ",
